...
b)},lf=function(a){var b={},c=[],d=a.length,e=0;z(a,function(f,g){var h=[];z(f.cells(),function(k){for(var q=0;void 0!==b[g+","+q];)q++;var r=k.element(),p=k.rowspan(),n=k.colspan(),t=q;r={element:m(r),rowspan:m(p),colspan:m(n),row:m(g),column:m(t)};for(p=0;p<k.colspan();p++)for(n=0;n<k.rowspan();n++)t=q+p,b[g+n+","+t]=r,e=Math.max(e,t+1);h.push(r)});c.push(wd(f.element(),h,f.section()))});return{grid:Bi(d,e),access:b,all:c}},C={fromTable:function(a){a=jf(a);return lf(a)},generate:lf,getAt:function(a,
...
function(c){c=tc.exec(c);return c=null!==c?parseFloat(c[1]):Md(a)/b.pixelWidth()*100})},Hf=function(a,b){return Za(a).fold(function(){return Md(a)},function(c){var d=Nd.exec(c);null!==d?c=parseInt(d[1],10):(c=tc.exec(c),c=null!==c?parseFloat(c[1])/100*b.pixelWidth():Md(a));return c})},If=function(a){var b;if(b=Bj(a)){var c=parseInt(b,10);b=qd(b,"%")&&"table"!==D(a)?Cj(a,c,sc,uc):c}else b=sc(a);a=ka(a,"rowspan",1);return b/a},Ej=function(a){return Za(a).bind(function(b){b=Aj.exec(b);return null!==
...
ab(a));if(!1===b)if(d=c.getParent(a.selection.getStart(),"table")){e=d;c=ab(a);var f=a.dom,g=E,h=f.getStyle(e,"width")||f.getAttrib(e,"width"),k=f.getStyle(e,"height")||f.getAttrib(e,"height"),q=f.getStyle(e,"border-spacing")||f.getAttrib(e,"cellspacing"),r=f.getAttrib(e,"cellpadding")||ne(a.dom,e,"padding"),p=wa(u.fromDom(e),"border-width");p=Ob(a)&&p.isSome()?p.getOr(""):f.getAttrib(e,"border")||ne(a.dom,e,"border-width")||ne(a.dom,e,"border");e=g({width:h,height:k,cellspacing:q,cellpadding:r,border:p,
caption:!!f.select("caption",e)[0],class:f.getAttrib(e,"class",""),align:te(a,e)},c?re(f,e):{})}else ab(a)&&(e.borderstyle="",e.bordercolor="",e.backgroundcolor="");else e.cols="1",e.rows="1",ab(a)&&(e.borderstyle="",e.bordercolor="",e.backgroundcolor="");c=qe(a.getParam("table_class_list",[],"array"));0<c.length&&e.class&&(e.class=e.class.replace(/\s*mce\-item\-table\s*/g,""));b=b?[{type:"input",name:"cols",label:"Cols",inputMode:"numeric"},{type:"input",name:"rows",label:"Rows",inputMode:"numeric"}]:
...
0<c.length&&a.ui.registry.addContextToolbar("table",{predicate:b,items:c,scope:"node",position:"node"})},hn=function(a,b,c){var d=function(h){return function(){return a.execCommand(h)}},e=function(h){var k=h.numRows,q=h.numColumns;a.undoManager.transact(function(){me(a,q,k,0,0)});a.addVisual()},f={text:"Table properties",onSetup:b.onSetupTable,onAction:d("mceTableProps")},g={text:"Delete table",icon:"table-delete-table",onSetup:b.onSetupTable,onAction:d("mceTableDelete")};a.ui.registry.addMenuItem("tableinsertrowbefore",
...
fancytype:"inserttable",onAction:e}]}});a.ui.registry.addMenuItem("inserttabledialog",{text:"Insert table",icon:"table",onAction:d("mceInsertTable")});a.ui.registry.addMenuItem("tableprops",f);a.ui.registry.addMenuItem("deletetable",g);a.ui.registry.addNestedMenuItem("row",{type:"nestedmenuitem",text:"Row",getSubmenuItems:function(){return"tableinsertrowbefore tableinsertrowafter tabledeleterow tablerowprops | tablecutrow tablecopyrow tablepasterowbefore tablepasterowafter"}});a.ui.registry.addNestedMenuItem("column",
{type:"nestedmenuitem",text:"Column",getSubmenuItems:function(){return"tableinsertcolumnbefore tableinsertcolumnafter tabledeletecolumn"}});a.ui.registry.addNestedMenuItem("cell",{type:"nestedmenuitem",text:"Cell",getSubmenuItems:function(){return"tablecellprops tablemergecells tablesplitcells"}});a.ui.registry.addContextMenu("table",{update:function(){b.resetTargets();return b.targets().fold(function(){return""},function(h){return"caption"===D(h.element())?"tableprops deletetable":"cell row column | advtablesort | tableprops deletetable"})}})},
