 ...
 * Licensed under MIT
 */
tinymce.PluginManager.add("bdmap",function(a,g){var b=tinymce.baseURL||".",d=b+"/plugins/bdmap/map.html";window.tinymceLng="";window.tinymceLat="";window.tinymceBDZoom="";window.tinymceBDW="";window.tinymceBDH="";window.tinymceBDBoxW="";window.tinymceBDBoxH="";window.tinymceBDBoxHtml="";window.tinymceBDDH="";window.tinymceBDSF="";window.tinymceBDBgColor="";window.tinymceBDDName="";var c=function(){return a.windowManager.openUrl({title:"\u63d2\u5165\u767e\u5ea6\u5730\u56fe",size:"large",url:d,buttons:[{type:"cancel",
text:"Close"},{type:"custom",text:"Save",name:"save",primary:!0}],onAction:function(e,f){switch(f.name){case "save":tinymceBDBoxHtml=tinymceBDBoxHtml.replace(/'/g,"\uffe5").replace(/"/g,"^").replace(/>/g,"\u3011").replace(/</g,"\u3010"),tinymceBDBgColor=tinymceBDBgColor.replace(/#/g,"@").replace(/\(/g,"+").replace(/\)/g,"-"),html='<iframe name="bdMap" src="'+b+"/plugins/bdmap/bd.html?center="+tinymceLng+"%2C"+tinymceLat+"&zoom="+(tinymceBDZoom?tinymceBDZoom:"14")+"&bwidth="+tinymceBDBoxW+"&bheight="+
