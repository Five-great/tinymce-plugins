...
e.ui.registry.addToggleButton("layout",{icon:"layout",tooltip:"\u4e00\u952e\u5e03\u5c40",onAction:function(){e.undoManager.transact(function(){v()})}});e.ui.registry.addMenuItem("layout",{text:"\u4e00\u952e\u5e03\u5c40",onAction:function(){e.undoManager.transact(function(){v()})}});return{getMetadata:function(){return{name:"\u4e00\u952e\u5e03\u5c40",url:"https://github.com/Five-great/tinymce-plugins"}}}});